...
public sealed class IOElementCodec8
{
	...
	/// </summary>
	public readonly byte oneByteValuesCount;
	...
	/// </summary>
	public readonly byte twoByteValuesCount;
	...
	/// </summary>
	public readonly byte fourByteValuesCount;
	...
	/// </summary>
	public readonly byte eightByteValuesCount;
...
/// <summary>
/// Abstract base class for Codec8 frame
/// </summary>
public abstract class Codec8FrameBase
{
	/// <summary>
	...
	public Codec8FrameBase( byte id, byte records1, byte records2, List<byte[]> avlData)
	{
		this.codecId = id;
...
/// <summary>
/// Codec8 frame with preamble, data field length and CRC16
/// </summary>
/// <remarks>For TCP</remarks>
public sealed class Codec8Frame : Codec8FrameBase
{
	/// <summary>
	...
	public Codec8Frame(ReadOnlySpan<byte> preamble, ReadOnlySpan<byte> dataFieldLength, byte id, byte records1, byte records2, List<byte[]> avlData, ReadOnlySpan<byte> crc) : base(id, records1, records2, avlData)
	{
...
/// <summary>
/// Codec8 frame without preamble, data field length and CRC16
/// </summary>
/// <remarks>For UDP</remarks>
public sealed class Codec8FrameNoCRC : Codec8FrameBase
{
	/// <summary>
	/// Constructor (only one)
	/// </summary>
	...
	/// <param name="records2">Number of records (second)</param>
	/// <param name="avlData">AVL data elements as list of bytes</param>
	public Codec8FrameNoCRC(byte id, byte records1, byte records2, List<byte[]> avlData) : base(id, records1, records2, avlData)
	{
